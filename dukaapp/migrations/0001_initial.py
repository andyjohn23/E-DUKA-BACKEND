# Generated by Django 3.1.3 on 2021-01-04 07:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', cloudinary.models.CloudinaryField(max_length=255, verbose_name='image')),
                ('comment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='product', to='dukaapp.comment')),
            ],
        ),
        migrations.CreateModel(
            name='Role',
